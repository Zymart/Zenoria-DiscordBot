...
- `/post_ready` prompts for your next message, combines up to 10 attached photos into one embed image, deletes your original message, uses the official Roblox group link, creates a permanent Discord invite, and posts link buttons.
