...
export const styledCategoryDefinitions = [
  ...
  },
  {
    ...
    channels: [
      ...
      { key: "ticket-for-applying", name: "🎫・ticket-for-applying", topic: "Open an application ticket here.", profile: "supportChannel" },
  ...
  },
  {
    ...
    channels: [
      ...
      { key: "finished-tasks", name: "✅・finished-tasks", topic: "Approved completed development tasks.", profile: "development" },
...
export const categoryDefinitions = [
  ...
  },
  {
    ...
    channels: [
      ...
      { name: "ticket-for-applying", topic: "Open an application ticket here.", profile: "supportChannel" },
  ...
  },
  {
    ...
    channels: [
      ...
      { name: "dev-log" },
      { name: "finished-tasks", profile: "development" },
